...
const descriptionStr = `
    A total of $${totalRaised.toLocaleString()} has been raised for ${numberOfGames.toLocaleString()} games.
    Currently, ${numberOfUnfundedGames} game${numberOfUnfundedGames === 1 ? ' remains' : 's remain'} unfunded.
